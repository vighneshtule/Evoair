!(function () {
  var e = {
        ...
        (t.analyticsProcessingAllowed = function () {
          ...
          (t.shopifyConsentAPI = function (
            ...
            return (({ useBugsnagReporting: e, useInstrumentation: t }) => {
              ...
              for (const e in n)
                n.hasOwnProperty(e) &&
                  (n[e] = u.includes(e) ? n[e] : a.withBugsnag(n[e]));
              return n;
            })(e);
          });
      },
      5732: function (e, t, n) {
                    ...
                    return {
                      ...
                      con: {
                        CMP: {
                          ...
                          [o.ConsentKeys.PREFERENCES]: d(
                            o.ConsentKeys.PREFERENCES
                          ),
                          [o.ConsentKeys.MARKETING]: d(o.ConsentKeys.MARKETING),
                          [o.ConsentKeys.SALE_OF_DATA]: d(
                            o.ConsentKeys.SALE_OF_DATA
                          ),
                        },
                      },
                      region: r || "",
                      cus: c,
                      purposes: {
                        [o.DataProcessingPurpose.ANALYTICS]: l(
                          o.DataProcessingPurpose.ANALYTICS
                        ),
                        [o.DataProcessingPurpose.PREFERENCES]: l(
                          o.DataProcessingPurpose.PREFERENCES
                        ),
                        [o.DataProcessingPurpose.MARKETING]: l(
                          o.DataProcessingPurpose.MARKETING
                        ),
                        [o.DataProcessingPurpose.SALE_OF_DATA]: l(
                          o.DataProcessingPurpose.SALE_OF_DATA
                        ),
                      },
        ...
        (t.CONSENT_COOKIE_NAME = i),
          (t.analyticsProcessingAllowed = function () {
            return l(o.DataProcessingPurpose.ANALYTICS);
          }),
          ...
          (t.marketingProcessingAllowed = function () {
            return l(o.DataProcessingPurpose.MARKETING);
          }),
          (t.preferencesProcessingAllowed = function () {
            return l(o.DataProcessingPurpose.PREFERENCES);
          }),
          (t.readCookieAndTransform = s),
          (t.saleOfDataAllowed = function () {
            return l(o.DataProcessingPurpose.SALE_OF_DATA);
          }),
          ...
          (t.setStorefrontApiTrackingConsent = function (e, t) {
            ...
            const a = {
              ...
              s = { v: o.CookieVersionV2, reg: "", con: { CMP: a } },
      ...
      5730: function (e, t, n) {
        ...
        function c() {
          if (
            (new i.Monorail().produce("getTrackingConsent"),
        ...
        (t.saleOfDataRegion = r.saleOfDataRegion),
          ...
          (t.getShopPrefs = function () {
            return (
              new i.Monorail().produce("getShopPrefs"),
          ...
          (t.isRegulationEnforced = function () {
            return (
              new i.Monorail().produce("isRegulationEnforced"),
              s.logger.warn(
          ...
          (t.shouldShowCCPABanner = function () {
            return (
              new i.Monorail().produce("shouldShowCCPABanner"),
              s.logger.warn(
                "shouldShowCCPABanner is deprecated and will be removed."
              ),
              r.saleOfDataRegion() &&
                _() === o.DisplayConsentValues.NO_INTERACTION
            );
          }),
      ...
      1928: function (e, t, n) {
        ...
        (t.appendConsentToCustomerAccountLinks = function (e) {
          ...
          for (const r of Array.from(t)) {
            ...
            if (
              (n && i.searchParams.set("consent_id", n),
      ...
      8740: function (e, t, n) {
        ...
        class r {
          constructor(e = !1) {
            if (((this.useInstrumentation = void 0), r.instance))
              return r.instance;
      ...
      8680: function (e, t, n) {
        ...
        t.storefrontApiUpdateTrackingConsent = function (e, t) {
          const n = e.granular_consent,
            ...
            _ = n.isExtensionToken
              ? "Shopify-Storefront-Extension-Token"
              : "x-shopify-storefront-access-token",
            f = {
              headers: { "content-type": "application/json", [_]: a },
              body: JSON.stringify(l(e)),
              method: "POST",
            };
          return fetch(`https://${p}/api/unstable/graphql.json`, f)
            .then((e) => {
            ...
            .then((a) => {
              ...
              const p = 31536e6,
                ...
                T =
                  null !==
                    (s =
                      null === (l = a.data.consentManagement) || void 0 === l
                        ? void 0
                        : l.customerAccountUrl) && void 0 !== s
                    ? s
                    : "";
              return (
                r.writeCookie(i.CONSENT_COOKIE_NAME, E, p, h),
                g &&
                  C &&
                  (r.writeCookie(u, E, _, g), r.writeCookie(d, E, _, C)),
                v !== E &&
                  (r.writeCookie(i.CONSENT_COOKIE_NAME, v, p, h),
                  g &&
                    C &&
                    (r.writeCookie(u, v, _, g), r.writeCookie(d, v, _, C))),
                o.dispatchEvents(e),
                c.appendConsentToCustomerAccountLinks(T),
                void 0 !== t && t(null, a),
                a
              );
            })
      ...
      1482: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/5.1"),
          (t.legacyStorefrontAnalyticsSchemaId =
            "storefront_customer_tracking/4.22"),
          (t.storefrontAnalyticsSchemaIdValidation =
      ...
      3988: function (e, t, n) {
        ...
        var g = (function (e) {
          function n(t, o, r) {
            ...
            return (a.pageID = f.default.microSessionId), a;
          }
          return (
            r(n, e),
            ...
            (n.prototype.addedProduct = function (e) {
              ...
              h.default.isEnabled(
                h.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION
              )
                ? this.produceToMonorail({
            ...
            (n.prototype.startedOrderOncePerCheckout = function (e) {
              ...
              this.produceToMonorail({
                ...
                eventObject: e,
                eventPayload: o,
                eventSchemaId: l.storefrontAnalyticsSchemaIdValidation,
              });
            }),
              ...
              if (
                ((t =
                  ...
                  (this.isCustomStorefront(n)
                    ? l.customStorefrontAnalyticsSchemaId
                    : l.storefrontAnalyticsSchemaId)),
                this.isCustomStorefront(n))
              ) {
                var s = this.eventWithMetadata(
                  n,
                  this.payloadWithCustomStorefrontMetadata(r),
                  o,
                  a
                );
                ...
                t === l.storefrontAnalyticsSchemaId
                  ? this.emitToStoreFrontCustomerTracking(c)
                  : this.emitToCustomSchema(c, t);
              }
            }),
            ...
            (n.prototype.emitToStoreFrontCustomerTracking = function (e) {
              var t = i(i({}, e), { emitted_to_v5: !0 }),
                n = {
                  schemaId: l.legacyStorefrontAnalyticsSchemaId,
                  payload: t,
                },
                o = [
                  "ccpa_enforced",
                ...
                a = { schemaId: l.storefrontAnalyticsSchemaId, payload: r };
              d.produce([n, a]);
            }),
                        ...
                        i(
                          {
                            ...
                            asset_version_id:
                              "e4b7dfbfa4ea6cc68d87e97829a12478d9c16c4b",
      ...
      4252: function (e, t, n) {
        ...
        function E(e) {
          if (
            void 0 === o &&
            (!d.default.isEnabled(d.TREKKIE_COOKIE_DOMAIN_FIX) || T(e))
          )
            if (
              (function () {
              ...
              for (
                var t = "", n = 0, r = c.hostname().split(".").reverse();
                n < r.length;
                n++
              ) {
                var i = r[n];
        ...
        (t.metricsSchemaId = "trekkie_metrics/2.0"),
          ...
          (t.sendToObserve = function (e) {
            ...
            if (this.shouldSendToObserve()) {
              var n = "e4b7dfbfa4ea6cc68d87e97829a12478d9c16c4b",
                o = null,
                r = null,
                i = null;
              if (e.app_config)
          ...
          c = (function () {
            ...
            return (
              (e.prototype.fetchOrSet = function (e, t, n) {
                ...
                o ||
                  ...
                  n &&
                    ...
                    (a.logMetricToMonorail("serverSideCookieNotSet_" + t),
              ...
              (e.prototype.shortTerm = function () {
                var e, n, o, i;
                return r.default.isEnabled(r.TREKKIE_COOKIE_DOMAIN_FIX)
                  ? null !==
                      (n =
                  ...
                  : null !==
                      (i =
                        null === (o = window.ShopPay) || void 0 === o
                          ? void 0
                          : o.trackingVisit) && void 0 !== i
                  ? i
      ...
      1074: function (e, t, n) {
          ...
          g = (function () {
            function e(e, t, n) {
              ...
              (this.integrations = []),
                ...
                E.default.initialize(t.Trekkie),
                h.default.initialize(t.Trekkie.enabledBetaFlags),
            ...
            return (
              ...
              (e.prototype.logAssetContext = function (e) {
                ...
                a.addBatchEvent({
                  ...
                  payload: {
                    build_id: "e4b7dfbfa4ea6cc68d87e97829a12478d9c16c4b",
              ...
              (e.prototype.handleConsentCollected = function (e) {
                E.default.refreshVisitorTokens(),
        ...
        var C = { "Added Product Next": "trekkie-next", default: "trekkie" };
      },
      8533: function (e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
  ...
  (n.d = function (e, t) {
    ...
    (function () {
      ...
      i.push(["S2S", s.S2S]);
      try {
        var c = window[r].config;
        if (c) {
          t.setGlobalSerializedAppConfig(JSON.stringify(c));
          var u = window[r],
            d = (window.trekkie = new e.Tricorder(i, c, function () {
              (window[r] = d),
                (window._visit = {
                  tag: function () {},
